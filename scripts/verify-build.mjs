...
assert.equal((html.match(/id="proyecto-/g) || []).length, 8, 'All eight projects must be in HTML');
...
console.log('Production checks passed: prerendered content, 8 projects, local assets, safe external links, SEO files and reduced-motion fallback.');
