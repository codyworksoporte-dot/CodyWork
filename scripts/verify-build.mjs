...
assert.equal((html.match(/id="proyecto-/g) || []).length, 9, 'All nine projects must be in HTML');
...
console.log('Production checks passed: prerendered content, 9 projects, local assets, safe external links, SEO files and reduced-motion fallback.');
